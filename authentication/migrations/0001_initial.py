    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2023, 5, 28, 5, 1, 46, 282074, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='Vehicle', to='api.vehicle')),
            ],
            options={
                'ordering': ['-lastupdated_at'],
                'abstract': False,
